...
function getData() {
    var PaymentType = require('bateeq-models').posmaster.PaymentType;
    ...
    paymentType.name = `name[${code}]`;
    paymentType.description = `description for ${code}`; 
...
before('#00. connect db', function(done) {
    helper.getDb()
        .then(db => {
            ...
            manager = new PaymentTypeManager(db, {
                username: 'unit-test'
            });
            done();
        })
